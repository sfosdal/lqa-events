...
- `scripts/soldout-check.mjs` + `scripts/soldout-run.sh` + `docker/soldout-browser/`
  ...
  `tickets` and `soldOut` onto the feed. Missed runs (Mac asleep) coalesce
